...
final class TwoFactorRepository implements RepoContract {
    ...
    public function insert(array $row): void {
        ...
        $tblEsc  = $isMysql ? '`two_factor`' : '"two_factor"';
     ...
     * [ 'user_id', 'method' ] = unikátní klíče (sloupce) pro konflikty,
     * [ 'secret', 'recovery_codes_enc', 'hotp_counter', 'enabled', 'last_used_at' ] = které sloupce aktualizovat.
     */
    public function upsert(array $row): void {
        ...
        $keys = [ 'user_id', 'method' ];
        $upd  = [ 'secret', 'recovery_codes_enc', 'hotp_counter', 'enabled', 'last_used_at' ];
