...
namespace BlackCat\Database\Packages\TwoFactor\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO TwoFactorDto:
...
final class TwoFactorDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'user_id', 'hotp_counter', 'version' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [];
    /** @var string[] */
    private const DATE_COLS   = [ 'created_at', 'last_used_at' ];
    /** @var string[] */
    private const BIN_COLS    = [ 'secret', 'recovery_codes_enc' ];
     ...
     * @return TwoFactorDto
     */
    public static function fromRow(array $row): TwoFactorDto
    {
        /** @var TwoFactorDto */
    ...
    public static function fromRowOrNull(?array $row): ?TwoFactorDto
    {
     ...
     *
     * @param TwoFactorDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(TwoFactorDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(TwoFactorDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(TwoFactorDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,TwoFactorDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,TwoFactorDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(TwoFactorDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,TwoFactorDto>
     */
