...
final class TwoFactorModule implements ModuleInterface
{
    public function name(): string { return 'table-two_factor'; }
    public function table(): string { return 'two_factor'; }
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [],
            'foreignKeys' => [ 'fk_two_factor_user' ],
        ];
    }
}
