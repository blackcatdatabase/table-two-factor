...
> Lineage: 1 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: todo · PII flags: 2 · Changelog: fresh (18 d)
...
| Pkg folder | [packages\two-factor](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\two-factor) | Repo location |
...
| Docs | **present** |
| Changelog | **present** |
| Changelog freshness | fresh (18 days; threshold 45) |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package two-factor -Apply
