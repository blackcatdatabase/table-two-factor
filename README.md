...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 1 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: todo · PII: 2 · Changelog: fresh (18 d)</div>
</div>
...
- Pkg folder: [packages\two-factor](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\two-factor)
...
graph LR
  ...
  two_factor["two_factor"]:::center
  two_factor -->|FK| users["users"]:::link
...
- Index coverage: todo (add PK and at least one index)
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package two-factor -Apply
